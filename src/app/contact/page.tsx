...
export default function ContactPage() {
  ...
  const departmentContacts = [
    { department: "Reception", phone: "+977-01-XXXXXXX", whatsapp: "+977-98XXXXXXXX", availability: "Sun-Fri 7AM-7PM" },
    { department: "Appointment Desk", phone: "+977-01-XXXXXXX", whatsapp: "+977-98XXXXXXXX", availability: "Sun-Fri 7AM-6PM" },
    { department: "Diagnostics/Lab", phone: "+977-01-XXXXXXX", whatsapp: "+977-98XXXXXXXX", availability: "Sun-Fri 7AM-5PM" },
    { department: "Products Counter", phone: "+977-01-XXXXXXX", whatsapp: "+977-98XXXXXXXX", availability: "Sun-Fri 8AM-7PM" },
    { department: "Corporate Wellness", phone: "+977-01-XXXXXXX", whatsapp: "+977-98XXXXXXXX", availability: "Sun-Fri 9AM-5PM" },
    { department: "Emergency Desk", phone: "+977-98XXXXXXXX", whatsapp: "+977-98XXXXXXXX", availability: "24/7 Available", isEmergency: true },
  ];
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="grow pt-[100px] md:pt-[104px] lg:pt-[112px]">
        {/* Hero Section */}
            ...
            <Container>
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div className="rounded-2xl overflow-hidden shadow-xl h-[300px] lg:h-[400px]">
                  <Image
                    src="https://images.unsplash.com/photo-1573348722427-f1d6819fdf98"
                    alt="Parking"
                    fill
