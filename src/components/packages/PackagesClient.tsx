...
export default function PackagesClient() {
  ...
  const handleFilterFind = () => {
    ...
    setFilteredMessage(
      `Found matched packages matching your criteria. Showing default recommended options below.`,
    );
  ...
  const testFeatures = [
    {
      test: "CBC",
      details: "TC,DC, Hb%, ESR, Plateletes, RBC, MCV,MCH,MCHC, PCV",
    },
    {
      test: "Sugar",
      details: "Fasting",
    ...
    {
      test: "Lipid Profile",
      details: "Total Chol, TG, HDL, LDL, VLDL Cholestrol",
    },
    {
      test: "LFT (Liver Function Test)",
      details:
        "T.Bilirubin, Total/Direct, GPT,GOT,ALP, Gama GT, Tatol Protein, Albumin, AG,Ratio",
    },
    {
      test: "KFT (Kidney Function Test)",
      details: "Urea, Creatinine, Na + /K+",
    },
    {
      test: "TFT (Thyroid Function Test)",
      details: "Free T3, T4 TSH",
    },
    {
      test: "Urine Test",
      details: "Urine Routine Examination",
    },
    {
      test: "Stool Test",
      details: "Stool Routine Examination",
    },
    {
      test: "Chest X-Ray",
      details: "Chest X-Ray",
    ...
    {
      test: "USG (Video X-Ray)",
      details: "USG",
    },
    {
      test: "ECG",
      details: "Electrocardiogram",
    },
    {
      test: "Physician Chekup",
        ...
        <Container className="relative z-10 text-center">
          <div className="max-w-4xl mx-auto flex flex-col items-center gap-5">
            ...
            <p className="text-base md:text-lg text-slate-500 font-medium leading-relaxed max-w-2xl mx-auto mt-2">
              Affordable, professionally designed health packages for
              individuals, families, seniors, and organizations.
            </p>
        ...
        <Container>
          <div className="text-center mb-16">
            ...
            <p className="text-sm text-slate-500 font-medium mt-1">
              Carefully curated diagnostics designed to yield advanced clinical
              insights
            </p>
          </div>
        ...
        <Container>
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-black text-slate-900 mt-1">
              General Health Check-up Program
            </h2>
            <p className="text-xs text-slate-500 font-bold mt-1">
              The following services are included in the facilities provided
              under the General Health Checkup by Kuntadevi Health Care:
            </p>
          </div>
            ...
            <table className="w-full min-w-[750px] border-collapse">
              <thead>
                <tr className="bg-slate-900 text-white text-xs font-black uppercase tracking-wider">
                  <th className="text-left py-6 px-6">Tests Included</th>
                  <th className="text-center py-6 px-4">Test Details</th>
                </tr>
              </thead>
      ...
      <section className="py-20 bg-white">
        <Container>
          <div className="text-center mb-16">
            ...
            <p className="text-sm text-slate-500 font-medium mt-1">
              Quickly locate specialized packages corresponding to your
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {healthNeeds.map((need, idx) => (
              ...
              >
                ...
                <Link
                  href={need.href}
                  className="inline-flex items-center gap-1.5 text-xs font-black text-[#0A7075] hover:underline mt-6"
                >
            ...
            <div className="lg:col-span-7 space-y-8">
              <div className="space-y-3">
                ...
                <p className="text-sm font-semibold text-slate-300 leading-relaxed max-w-xl">
                  Empower your workforce with clinical-grade health checks. We
                  offer completely custom panel builds, dedicated coordinators,
                  and secure aggregate digital health cards for your management.
                </p>
              </div>
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  <li
                    key={idx}
                    className="flex items-center gap-3 text-xs font-extrabold text-slate-200"
                  >
              ...
              <div className="pt-6 border-t border-white/10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
                ...
                <div className="flex flex-wrap gap-4">
                  <Button
                    className="h-12 px-6 rounded-xl bg-[#0A7075] hover:bg-primary-dark text-white border-none font-bold text-xs"
                    asChild
                  >
                    <Link href="/contact">Request Proposal</Link>
                  </Button>
                  <Button
                    className="h-12 px-6 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white border-none font-bold text-xs flex items-center gap-2"
                    asChild
                  >
                    <a
                      href={`https://wa.me/${PHONE_WHATSAPP.replace(/[^0-9]/g, "")}`}
                      target="_blank"
        ...
        <Container>
          <div className="text-center mb-16 space-y-3">
            ...
            <p className="text-slate-500 font-medium">
              Four clear steps to finalize your wellness diagnostics
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 relative max-w-5xl mx-auto">
            ...
            <div className="text-center space-y-4 group">
              ...
              <p className="text-xs text-slate-500 font-semibold leading-relaxed px-4">
                Browse our curated wellness tests and choose the best fit for
            ...
            <div className="text-center space-y-4 group">
              ...
              <p className="text-xs text-slate-500 font-semibold leading-relaxed px-4">
                Pick a slot online. Our reception confirms your exact timings
                within 30 minutes.
              </p>
            </div>
            ...
            <div className="text-center space-y-4 group">
              ...
              <p className="text-xs text-slate-500 font-semibold leading-relaxed px-4">
                Walk into Ghattekulo for sample collection with friendly
                clinical support.
              </p>
            </div>
            ...
            <div className="text-center space-y-4 group">
              ...
              <p className="text-xs text-slate-500 font-semibold leading-relaxed px-4">
                Download verified high-fidelity digital reports via WhatsApp on
                the same day.
              </p>
            </div>
          </div>
      ...
      <section className="py-20 bg-white">
        <Container>
          <div className="text-center mb-16">
            ...
            <p className="text-sm text-slate-500 font-medium mt-1">
              Verified patient feedback regarding our diagnostic laboratory
            </p>
          </div>
        ...
        <Container>
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-sm text-slate-500 font-medium mt-1">
                Get details regarding schedules, fasting, and reports delivery.
              </p>
            </div>
                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      isOpen
                        ? "shadow-[0_4px_25px_rgba(0,0,0,0.03)] border-teal-100/80 bg-teal-50/10"
                        : "",
                    )}
                  >
                    <button
                    ...
                    >
                      <span className="font-extrabold text-slate-800 text-xs md:text-sm leading-snug">
                        {item.q}
                      </span>
                      <span
                        className={cn(
                          ...
                          isOpen
                            ? "bg-[#0A7075] border-[#0A7075] text-white rotate-180"
                            : "",
                        )}
                      >
                    ...
                    <div
                      className={cn(
                        ...
                        isOpen
                          ? "max-h-[300px] opacity-100 border-t border-slate-100/60"
          ...
          <div className="bg-linear-to-r from-[#0A7075] to-secondary rounded-3xl p-10 md:p-16 text-white text-center relative overflow-hidden group shadow-xl">
            ...
            <div className="max-w-2xl mx-auto space-y-6 relative z-10">
              ...
              <p className="text-xs md:text-sm text-white/80 font-semibold leading-relaxed">
                Unlock early medical diagnostic insights and stay ahead. Book a
                checkup for yourself or message us instantly.
              </p>

              <div className="flex flex-wrap justify-center gap-4 pt-4">
                <Button
                  className="h-12 px-8 rounded-xl bg-white hover:bg-slate-50 text-[#0A7075] font-extrabold border-none shadow-md"
                  asChild
                >
                  <Link href="/appointment">Book Package</Link>
                </Button>
                <Button
                  variant="outline"
                  className="h-12 px-8 rounded-xl border-white/30 text-white bg-white/10 hover:bg-white/20 hover:border-white/50"
                  asChild
                >
                  <a
                    href={`https://wa.me/${PHONE_WHATSAPP.replace(/[^0-9]/g, "")}`}
